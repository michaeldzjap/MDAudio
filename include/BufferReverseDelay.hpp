#ifndef MD_AUDIO_BUFFER_REVERSE_DELAY_HPP
#define MD_AUDIO_BUFFER_REVERSE_DELAY_HPP
...
namespace md_audio {
    ...
    class BufferReverseDelay : public Unit {
    public:
        explicit BufferReverseDelay(Buffer<Allocator>& buffer, double max_size, double size) :
            m_buffer(buffer),
            m_writer(m_buffer),
            m_reader(m_buffer),
...
#endif /* MD_AUDIO_BUFFER_REVERSE_DELAY_HPP */
