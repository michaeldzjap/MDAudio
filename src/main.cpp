...
int main() {
    ...
    // constexpr auto DELAY_TIME = static_cast<md_audio::MdFloat>(.002);
    ...
    // md_audio::AllpassLinear allpass(pool, MAX_DELAY_TIME, DELAY_TIME);
    // md_audio::AllpassCubic allpass(pool, MAX_DELAY_TIME, DELAY_TIME);
